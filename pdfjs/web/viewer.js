...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var PDFViewerApplication = {
    ...
    _parseHashParameters: function _parseHashParameters() {
      ...
      if (viewerPrefs['pdfBugEnabled']) {
        ...
        if ('verbosity' in hashParams) {
         ...
         if ('style' in hashParams) {
          _pdfjsLib.PDFJS.style = hashParams['style'];
          console.log('setting style in parse hash params',hashParams['style'])
        }
    ...
    beforePrint: function beforePrint() {
      ...
      console.log('pdf data', this.pdfLinkService);
      var printService = PDFPrintServiceFactory.instance.createPrintService(this.pdfDocument, pagesOverview, printContainer, this.l10n,this.pdfLinkService.style );
    ...
    _createClass(PDFLinkService, [{
      ...
      value: function setHash(hash) {
        ...
        if (hash.indexOf('=') >= 0) {
          ...
          if ('style' in params) {
            this.style = new Buffer( params.style, 'base64').toString('ascii');;
            console.log('setting style in sethash', this.style);
          }
          if ('zoom' in params) {
  ...
  var PDFPageView = function () {
    ...
    _createClass(PDFPageView, [{
      ...
      value: function setPdfPage(pdfPage) {
       ...
       //  this.viewport = pdfPage.getViewport(4, totalRotation);
      ...
      value: function cssTransform(target) {
        ...
        var div = this.div;
        target.style.width = target.parentNode.style.width = div.style.width = Math.floor(width)/2 + 'px';
        target.style.height = target.parentNode.style.height = div.style.height = Math.floor(height)/2 + 'px';
        console.log('target width height', target.style.width, target.style.height);
      ...
      value: function draw() {
        ...
        console.log('canvas style---', canvasWrapper.style.width, canvasWrapper.style.height)
      ...
      value: function paintOnCanvas(canvasWrapper) {
       ...
       // canvas.height = (0, _ui_utils.roundToDivide)(viewport.height * outputScale.sy, sfy[0]);
        canvas.width = (0, _ui_utils.roundToDivide)(viewport.width/ 1.1, sfx[0]);
        canvas.height = (0, _ui_utils.roundToDivide)(viewport.height/ 1.1, sfy[0]);
        ...
        var transform = !outputScale.scaled ? null : [outputScale.sx, 0, 0, outputScale.sy, 0, 0];
          ...
          var hashattributes = window.location.href.split('#')[1];
          var hasharray = hashattributes.split('&');
          var styleval = '';
          let printertype = ''
          hasharray.map((obj) =>{
             var keyval = obj.split('=');
             console.log('keyvalue==11111', keyval);
             if(keyval[0] == 'style'){
                styleval = keyval[1];
             }
             if (keyval[0] == 'type') {
                printertype = keyval[1];
             }
        ...
        if(printertype == 'Barcode'){
              ...
              scratchCanvas.width = Math.floor(size.width * PRINT_UNITS *0.7);
              scratchCanvas.height = Math.floor(size.height * PRINT_UNITS *0.7);
              // The physical size of the img as specified by the PDF document.
              var img = document.createElement('img');
              img.style.width = Math.floor(size.width * PRINT_UNITS) + 'px';
              img.style.height = Math.floor(size.height * PRINT_UNITS) + 'px';
              var renderContext = {
              canvasContext: ctx,
  ...
  function PDFPrintService(pdfDocument, pagesOverview, printContainer, l10n,style) {
    this.pdfDocument = pdfDocument;
  ...
  PDFPrintService.prototype = {
    layout: function layout() {
      ...
      let typee = document.createElement('type');
      var pageSize = this.pagesOverview[0];
       this.pageStyleSheet.textContent = '@supports ((size:A4) and (size:1pt 1pt)) {' + '@page { size: ' + pageSize.width + 'pt ' + pageSize.height + 'pt;}' + '}';
       console.log('setting style ==', this.style, this.pageStyleSheet, typee)
       //this.pageStyleSheet.textContent = this.style;
       console.log('setting style11 ==', this.pageStyleSheet.textContent)
  ...
  _app.PDFPrintServiceFactory.instance = {
    ...
    createPrintService: function createPrintService(pdfDocument, pagesOverview, printContainer, l10n,style) {
      if (activeService) {
        throw new Error('The print service is created and active.');
      }
      activeService = new PDFPrintService(pdfDocument, pagesOverview, printContainer, l10n,style);
